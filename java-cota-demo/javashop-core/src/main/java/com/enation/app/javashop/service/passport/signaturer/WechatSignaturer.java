package com.enation.app.javashop.service.passport.signaturer;
...
import com.enation.app.javashop.model.member.exception.WeixinSignatrueExceprion;
import com.enation.app.javashop.model.payment.dto.WechatDTO;
import com.enation.app.javashop.model.payment.vo.SignatureParams;
import com.enation.app.javashop.model.payment.vo.WechatCgiAccessToken;
import com.enation.app.javashop.model.payment.vo.WechatJsapiTicket;
...
public class WechatSignaturer {
    ...
    public Map signature(String type, String url) {
        ...
        try {
            ...
            if (object == null) {
                ...
                //获取access
                signatureParams.setWechatCgiAccessToken(this.getCgiAccessToken(config.get("app_id"), config.get("app_key")));
                signatureParams.setWechatJsapiTicket(getJsapiTicket(signatureParams.getWechatCgiAccessToken().getAccessToken()));
    ...
    public String getCgiAccessToken(WechatTypeEnmu wechatTypeEnmu) {
        ...
        WechatCgiAccessToken wechatCgiAccessToken = this.getCgiAccessToken(map.get("app_id"), map.get("app_key"));
        if (wechatCgiAccessToken == null) {
            return null;
        }
        return wechatCgiAccessToken.getAccessToken();
    }
     ...
     * @return
     */
    public WechatCgiAccessToken getCgiAccessToken(String appid, String secret) {
        ...
        WechatCgiAccessToken wechatCgiAccessToken = new WechatCgiAccessToken();
        wechatCgiAccessToken.setAccessToken(accessToken);
        wechatCgiAccessToken.setExpires(Integer.valueOf(expires));
