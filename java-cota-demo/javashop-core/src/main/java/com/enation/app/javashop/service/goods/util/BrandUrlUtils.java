...
public class BrandUrlUtils {
     ...
     * @return
     */
    public static BrandDO findBrand(List<BrandDO> brandList, Long brandid) {
     ...
     * @return
     */
    public static List<SearchSelector> createSelectedBrand(List<BrandDO> brandList, Long brandId) {
